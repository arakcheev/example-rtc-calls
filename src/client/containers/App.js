...
/**
 * These objects fields will be the props value of component
 * @param state
 * @returns {{streams: (*|streams|ReadonlyArray<MediaStream>|MediaStream[]), peers: (peers|*), alerts: (alerts|*), notifications: (*|notifications), active: *}}
 */
